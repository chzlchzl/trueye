...
def main(config):
    ...
    if config.dataset in ['CelebA', 'Both']:
        celeba_loader = get_loader("C:/Users/chzlzl/Desktop/disrupting-deepfakes-master/data/celeba/images", config.attr_path, config.selected_attrs,
    ...
    if config.mode == 'train':
        ...
        if config.dataset in ['CelebA', 'RaFD']:
            ...
            # Attack inference
            solver.test_attack()
            # solver.test_attack_blur()
            # Feature attack experiment
            # solver.test_attack_feats()
            # solver.test_attack_perturb()
