...
class LinfPGDAttack(object):
    def __init__(self, model=None, device=None, epsilon=0.05, k=10, a=0.01, feat = True):
        """
    ...
    def perturb(self, X_nat, y, c_trg):  #기본적인 PGD방식의 공격
        """
        Vanilla Attack.
        """
        if self.rand:
    ...
    def perturb_blur(self, X_nat, y, c_trg): # 블러 pre-processing 방어 (화이트 박스 공격)
        """
    ...
    def perturb_blur_iter_full(self, X_nat, y, c_trg):  # 다양한 블러 방어 기법에 대한 스프레드 스펙트럼 공격 
        """
